...
export default function EnquiriesPage() {
  ...
  const processEmailMutation = useMutation({
    mutationFn: async (text: string) => {
      try {
        const result = await initiateProjectFromEmail({ emailContent: text });
        ...
        throw new Error(err.message || 'The AI could not process this email. Please check your API key configuration.');
      }
    },
    onSuccess: () => {
